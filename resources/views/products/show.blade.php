...
@section('content')
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8"
        x-data="productPage({{ $product->id }}, {{ $product->display_price }})">
        ...
        <div class="grid gap-10 lg:grid-cols-2">
            ...
            <div class="animate-fade-up delay-150ms">
                ...
                <div class="mt-8 grid grid-cols-3 gap-3">
                    ...
                    <div class="rounded-xl bg-slate-50 p-3 text-center dark:bg-white/5">
                        <span class="text-xl">💰</span>
                        <p class="mt-1 text-[10px] font-medium text-slate-500">Bayar COD<br>di tempat</p>
                    </div>
                    <div class="rounded-xl bg-slate-50 p-3 text-center dark:bg-white/5">
                        <span class="text-xl">✅</span>
                    ...
                    @foreach ($related as $item)
                        <div class="card group overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <p class="mt-1 text-sm font-semibold text-primary dark:text-primary-soft">Rp {{ number_format($item->display_price, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
...
@push('scripts')
<script>
    function productPage(productId, defaultPrice) {
        return {
            productId,
            defaultPrice,
            ...
            selectVariant(id, price, stock, name) {
                ...
                this.selectedPrice = price || this.defaultPrice;
