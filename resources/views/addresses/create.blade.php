...
@section('title', 'Tambah Alamat - ALGO NATION')
...
@section('content')
    <div class="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="animate-fade-up">
            ...
            <h1 class="mt-2 font-display text-3xl font-extrabold">Tambah Alamat Baru</h1>
        </div>

        <form method="POST" action="{{ route('addresses.store') }}" class="card-flat animate-fade-up mt-6 p-6">
            @csrf
            ...
            <div class="mt-6 flex gap-3">
                ...
                <button type="submit" class="btn-primary flex-1 justify-center">Simpan Alamat</button>
            </div>
        </form>
    </div>
@endsection
